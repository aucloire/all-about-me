...
![Foto Diri Ellaine Juvina](images/ellaine_headshot.png){width=35% style="border-radius: 50%; border: 3px solid #00000000;"}
...
![Ellaine's Ballet Core Memory](images/ballet.png){width=30% style="border-radius: 50%; border: 3px solid #00000000;"}
![Ellaine as 12 MIA 1's Magician](images/sendratasik.png){width=30% style="border-radius: 50%; border: 3px solid #00000000;"}
![Ellaine's Fangirling Agenda](images/kpop.png){width=30% style="border-radius: 50%; border: 3px solid #00000000;"}

### Eksplorasi & Pencapaian Terkini: Fondasi Kebebasan {.unnumbered}

![Ellaine's First Step in ITB](images/ellaine_itbbackshot.png){width=30% style="border-radius: 50%; border: 3px solid #00000000;"}
![Ellaine at OSKM 2025](images/oskm.png){width=30% style="border-radius: 50%; border: 3px solid #00000000;"}
![Arkavidia's Mascot!](images/maskot_arkav.png){width=30% style="border-radius: 50%; border: 3px solid #00000000;"}
